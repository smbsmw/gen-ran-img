...
import (
	...
	"youtube-downloader-rest/internal/downloader"
...
type TaskConsumerGroup struct {
	...
	log          logger.Logger
	cfg          *config.Config
	downloaderUC downloader.Usecase
}
...
func (tcg *TaskConsumerGroup) RunConsumers(ctx context.Context, cancel context.CancelFunc) {
	go tcg.consumeCreateTask(ctx, cancel, tasksGroupID, taskTopic, taskWorkers)
}
